      ...
      <AnimatePresence mode="wait">
        {success ? (
          ...
          >
            ...
            <p className="text-sm font-medium text-neutral-100">注册成功</p>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="mt-6 w-full rounded-full bg-neutral-100 text-black py-2.5 text-xs font-medium tracking-wide hover:bg-white transition-colors"
            >
              我知道了
            </motion.button>
          </motion.div>
      ...
      >
        <div className="rounded-3xl border border-neutral-800/80 bg-gradient-to-b from-neutral-950/90 to-black/80 px-6 py-7 shadow-[0_24px_80px_rgba(15,23,42,0.85)] backdrop-blur-sm space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="text-[11px] text-neutral-400">密码（至少 6 位）</label>
              <div className="relative rounded-xl border border-neutral-800/80 bg-neutral-950/60 px-3 py-2.5 flex items-center gap-2">
            ...
            <div className="space-y-2">
              <label className="text-[11px] text-neutral-400">确认密码</label>
              <div className="relative rounded-xl border border-neutral-800/80 bg-neutral-950/60 px-3 py-2.5 flex items-center gap-2">
                <Lock className="h-3.5 w-3.5 text-neutral-500 shrink-0" />
                <input
                  type="password"
